  ...
  return (
    ...
    >
      <div className='flex flex-col relative'>
        <input
          className='sm:w-80 w-full text-grey bg-white bg-opacity-20 border-2 border-orange py-2 px-3 rounded-xl  focus:bg-opacity-100 focus:border-opacity-0 transition duration-500'
